...
3. Install the required libraries mentioned below: 
...
```
4. To run app.R, The run button in the r-studio menu can be used to launch the CNN model, which is deployed in the app.R file.
